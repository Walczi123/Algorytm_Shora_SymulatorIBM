...
from cirq_modules.arithmetic_gate import ArithmeticGate
...
def make_order_finding_circuit(x: int, n: int) -> cirq.Circuit:
    ...
    return cirq.Circuit(
        ...
        ModularExp([2] * len(target), [2] * len(exponent),
                   x, n).on(*target + exponent),
...
if __name__ == '__main__':
    # coverage: ignore
    ORDER_FINDERS = {'naive': naive_order_finder,
